namespace DetectPublicApiChanges.Tests.TestCases
{
    /// <summary>
    /// Contains all available use cases
    /// </summary>
    public static class TestCase
    {
        ...
        public const string InternalSealedClass = "DetectPublicApiChanges.Tests.TestCases.InternalSealedClass.txt";
        public const string PublicStaticClass = "DetectPublicApiChanges.Tests.TestCases.PublicStaticClass.txt";
        public const string PrivateClassInsidePublicClass = "DetectPublicApiChanges.Tests.TestCases.PrivateClassInsidePublicClass.txt";
