...
namespace DetectPublicApiChanges.Report
{
	...
	public class BreakingChangesReportViewModelCreator : IReportViewModelCreator
	{
		/// <summary>
		...
		{
			var indexComparison = data["results"].As<IStructureIndexComparisonResult>();
			var changeLog = data["changeLog"].As<ISourceControlChangeLog>();
