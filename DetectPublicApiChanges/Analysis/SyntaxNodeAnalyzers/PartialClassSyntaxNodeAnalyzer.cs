...
namespace DetectPublicApiChanges.Analysis.SyntaxNodeAnalyzers
{
	...
	public class PartialClassSyntaxNodeAnalyzer : ISyntaxNodeAnalyzer
	{
		...
		public IIndexItem CreateItem(SyntaxNode syntaxNode)
		{
			...
			return _indexItemFactory.CreateItem(CreateKey(node), syntaxNode, Descriptor.AddObsoleteInformation(ObsoleteSyntaxNodeAnalyzer.GetObsoleteInformation(syntaxNode)).AddDescription($"The partial class {node.Identifier.ValueText} seems to be have been changed or removed"));
		}
