...
namespace DetectPublicApiChanges.Analysis.SyntaxNodeAnalyzers
{
	...
	/// </summary>
	public class GenericMethodSyntaxNodeAnalyzer : ISyntaxNodeAnalyzer
	{
		/// <summary>
		...
		{
			DiagnosticId = "GenericMethodMissing",
			Category = "Method"
		};
		...
		public GenericMethodSyntaxNodeAnalyzer(IIndexItemFactory indexItemFactory)
		{
		...
		public IIndexItem CreateItem(SyntaxNode syntaxNode)
		{
			...
			return _indexItemFactory.CreateItem(CreateKey(node), syntaxNode, Descriptor.AddObsoleteInformation(ObsoleteSyntaxNodeAnalyzer.GetObsoleteInformation(syntaxNode)).AddDescription($"The generic method {node.Identifier.ValueText} seems to be have been changed or removed"));
		}
