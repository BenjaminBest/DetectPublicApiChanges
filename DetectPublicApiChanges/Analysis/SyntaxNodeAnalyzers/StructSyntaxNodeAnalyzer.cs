...
namespace DetectPublicApiChanges.Analysis.SyntaxNodeAnalyzers
{
    ...
    /// </summary>
    public class StructSyntaxNodeAnalyzer : ISyntaxNodeAnalyzer
    {
        /// <summary>
        ...
        public StructSyntaxNodeAnalyzer(IIndexItemFactory indexItemFactory)
        {
        ...
        public IIndexItem CreateItem(SyntaxNode syntaxNode)
        {
            ...
            return _indexItemFactory.CreateItem(CreateKey(node), syntaxNode, Descriptor.AddDescription($"The struct {node.Identifier.ValueText} seems to be have been changed or removed"));
        }
