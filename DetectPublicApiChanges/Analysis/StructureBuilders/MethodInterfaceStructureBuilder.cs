...
{
    /// <summary>
    /// The MethodInterfaceStructureBuilder creates a structure based on a parameter syntax
    /// </summary>
    public class MethodInterfaceStructureBuilder : ITypeStructureBuilder<InterfaceDeclarationSyntax, MethodStructure>
    {
        /// <summary>
        ...
        public MethodInterfaceStructureBuilder(
        ...
        /// <returns></returns>
        public IEnumerable<MethodStructure> Build(InterfaceDeclarationSyntax syntax)
        {
